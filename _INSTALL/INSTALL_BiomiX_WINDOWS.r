...
install.packages("bslib_0.8.0.zip", repos=NULL, type="source")
...
install.packages("cli_3.6.3.zip", repos=NULL, type="source")
...
install.packages("curl_5.2.3.zip", repos=NULL, type="source")
...
install.packages("desc_1.4.3.zip", repos=NULL, type="source")
...
install.packages("digest_0.6.37.zip", repos=NULL, type="source")
install.packages("downlit_0.4.4.zip", repos=NULL, type="source")
...
install.packages("evaluate_1.0.1.zip", repos=NULL, type="source")
...
install.packages("highr_0.11.zip", repos=NULL, type="source")
install.packages("hms_1.1.3.zip", repos=NULL, type="source")
install.packages("htmltools_0.5.8.1.zip", repos=NULL, type="source")
...
install.packages("httr2_1.0.5.zip", repos=NULL, type="source")
...
install.packages("jsonlite_1.8.9.zip", repos=NULL, type="source")
install.packages("KernSmooth_2.23-20.zip", repos=NULL, type="source")
install.packages("knitr_1.48.zip", repos=NULL, type="source")
...
install.packages("lifecycle_1.0.4.zip", repos=NULL, type="source")
...
install.packages("pkgbuild_1.4.4.zip", repos=NULL, type="source")
#install.packages("pkgconfig_2.0.3.zip", repos=NULL, type="source")
install.packages("pkgdown_2.1.1.zip", repos=NULL, type="source")
install.packages("pkgload_1.4.0.zip", repos=NULL, type="source")
library(pkgload)
...
install.packages("processx_3.8.4.zip", repos=NULL, type="source")
install.packages("prodlim_2023.03.31.zip", repos=NULL, type="source")
install.packages("profvis_0.4.0.zip", repos=NULL, type="source")
...
install.packages("remotes_2.5.0.zip", repos=NULL, type="source")
...
#install.packages("rlang_1.1.4.zip", repos=NULL, type="source")
install.packages("rlist_0.4.6.2.zip", repos=NULL, type="source")
install.packages("rmarkdown_2.28.zip", repos=NULL, type="source")
install.packages("roxygen2_7.3.2.zip", repos=NULL, type="source")
...
install.packages("sass_0.4.9.zip", repos=NULL, type="source")
...
install.packages("shiny_1.9.1.zip", repos=NULL, type="source")
...
install.packages("testthat_3.2.1.1.zip", repos=NULL, type="source")
...
#Instable packages (External)

install.packages("RJSONIO_1.3-1.9.zip", repos=NULL, type="source")
...
install.packages("ISOcodes_2024.02.12.zip", repos=NULL, type="source")
...
#Ending Instable packages (External)
