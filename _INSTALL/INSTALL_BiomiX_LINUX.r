...
install.packages("reticulate", version="1.31")
install.packages("XML", version="3.99.0.14")
install.packages("xml2", version="2.4.5")
...
BiocManager::install("ChAMPdata", version=3.16)
BiocManager::install("ChAMP", version = "3.16")
BiocManager::install("MOFA2", version = "3.16")
BiocManager::install("MSnbase", version = "3.16")
BiocManager::install("Rdisop", version = "3.16")
